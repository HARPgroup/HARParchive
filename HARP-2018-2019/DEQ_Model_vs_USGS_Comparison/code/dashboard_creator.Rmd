...
container <- "C:\\aa_HARP\\aa_GitHub\\HARParchive\\HARP-2018-2019\\DEQ_Model_vs_USGS_Comparison"
...
```
---
title: "Appendix I.3: USGS Gage `r paste(siteNo, "vs.", RivSeg)`"
output:
  pdf_document: default
---
...
##source(paste(hydro_tools, "HARP-2018/DEQ_Model_vs_USGS_Comparison/code/fn_gage+seg_mapper.R", sep = "/"));
source(paste(github_location,"/HARParchive/HARP-2018-2019/DEQ_Model_vs_USGS_Comparison/code/fn_gage+seg_mapper.R", sep = "/"));
