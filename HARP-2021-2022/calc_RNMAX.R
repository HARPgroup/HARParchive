## This script is used to calculate .RNMAX timeseries for NLDAS land segments
## HARP Group
...
AllLandsegList <- c("N51800", "N51550", "N51810", "N51037", "N51093", "N51111", "N51053", "N51740", "N51710", "N51121", "N51135", "N51149",
                    ...
                    "A51019", "A51023", "A51031", "A51045", "A51121", "A51161", "A51515", "A51770", "A51775", "B51019",
                    "B51071", "B51161", "C51071", "F51045", "F51121", "F51161")
...
while(i<=length(AllLandsegList)){
  ...
  df_rad <- read.table(paste0("http://deq1.bse.vt.edu:81/met/out/lseg_csv/1984010100-2020123123/",landseg,".RAD"), header = FALSE, sep = ",")
  #df_rad <- read.table(paste0("/backup/meteorology/out/lseg_csv/1984010100-2020123123/",landseg,".RAD"), header = FALSE, sep = ",")  
  colnames(df_rad) <- c("year", "month", "day", "hour", "solar_rad")
  df_rnmax <- sqldf("select month, day, hour, max(solar_rad) as RNMAX from df_rad GROUP BY month, day, hour")
  
  # write table to terminal
  write.table(df_rnmax, paste0("/backup/meteorology/out/lseg_csv/1984010100-2020123123/",landseg,".RNMAX"), row.names = FALSE, col.names = TRUE, sep = ",")
