##### This script creates a comparison graph of the three different evapotranspiration methods
##### For individual landsegment testing purposes only
...
p <- ggplot(NULL, aes(x=dailyPET$date))+
  ...
  xlab("Date")+
  ylab("Evapotranspiration (in/day)")
