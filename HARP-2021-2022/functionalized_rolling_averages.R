#functionalizing the rolling averages table 
...
AllLandsegList <- c("N51800", "N51550", "N51810", "N51037", "N51093", "N51111", "N51053", "N51740", "N51710", "N51121", "N51135", "N51149", 
                    ...
                    "F51121", "F51161")
get_rolling_avgs <- function(dfTMP,dfPRC, dfPET){
  ...
  df <- cbind(dailyPrecip, dailyPET, dailyTemp)
  ...
  rollingAVG <- cbind(df, rolling_7day_PRC, rolling_30day_PRC, rolling_90day_PRC, rolling_7day_PET, 
...
while(i<=length(AllLandsegList)){
  ...
  rollingAVG <- get_rolling_avgs(dfTMP = dfTMP, dfPRC = dfPRC, dfPET = dfHET)
 
   # create and save PET file as csv
  write.table(rollingAVG,paste0("/Users/katealbi/Desktop/HARP/",landseg,"rollingAVG.csv"), 
