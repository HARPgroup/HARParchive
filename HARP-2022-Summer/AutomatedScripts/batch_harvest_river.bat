...
Rscript ~/HARParchive/HARP-2022-Summer/AutomatedScripts/csv_export_wdm_format.R $output_path/hydr/$basin'_hydr.csv' $output_path/ovol3/$basin'_ovol3.csv' 'Qout'
