...
#rseg.flow.1 <- zoo(as.numeric(as.character( rseg.data.1$Qout )), order.by = rseg.data.r$date)
...
#rseg.flow.2 <- zoo(as.numeric(as.character( rseg.data.2$Qout )), order.by = rseg.data.r$date)
