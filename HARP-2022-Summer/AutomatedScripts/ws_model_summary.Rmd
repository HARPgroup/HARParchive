...
library(dplyr)
library(data.table)
library(micropan) # to overcome error finding gregexec() function
basepath='/var/www/R'
...
for (r in 1:length(rseg.model.version)) {
  ...
  length = lendf[rownum, 3]
  assign(paste0('length.',r),length)
}
```
...
persp(x, y, z, theta = 5, phi = 15, expand = .2, col = "#0099CC", axes=TRUE, nticks=8, ticktype="detailed", scale=TRUE, shade=0.65, border="003300", d=0.6, r=9, xlab="Width (ft)",
      ...
      main=paste(model$propname, "Cross-section"),
...
persp(x, y, z, theta = 10, phi = 15, expand = .2, col = "#0099CC", axes=TRUE, nticks=8, ticktype="detailed", scale=TRUE, shade=0.65, border="003300", d=0.6, r=9, xlab="Width (ft)", ylab="Channel Length (ft)", zlab="Depth (ft)", main=paste(model$propname, "Cross-section"), sub=paste("Bankfull Depth is approx.", ftable$depth[10], "ft"))

persp(x, y, z, theta = -5, phi = -15, expand = .2, col = "#0099CC", axes=TRUE, nticks=8, ticktype="detailed", scale=TRUE, shade=0.65, border="003300", d=0.6, r=9, xlab="Width (ft)", ylab="Channel Length (ft)", zlab="Depth (ft)", main=paste(model$propname, "Cross-section"), sub=paste("Bankfull Depth is approx.", ftable$depth[10], "ft"))
