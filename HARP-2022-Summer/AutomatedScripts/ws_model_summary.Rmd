...
params: 
  ...
  id1: 605598 #67924  #hydroid !
    #rseg for 605598 is PU0_6080_5620
  ftype1: "cbp60"
  modelv1: "cbp-6.0" #propcode
  scenario1: 'hsp2_2022'
  
  id2: 67783 #478766  #hydroid !
  ftype2: 'vahydro'
  modelv2: "vahydro-1.0" 
  scenario2: '11'
---
...
model1 <- RomProperty$new(
          ds,
          list(entity_type='dh_feature', featureid = id1, propcode=modelv1),
          TRUE
          )
...
model2 <- RomProperty$new(
          ds,
          list(entity_type='dh_feature', featureid = id2, propcode=modelv2),
          TRUE
          )
...
elid <- model2_info[[1]]$om_element_connection$value

# get model data via elid
model2_flows <- om_get_rundata(elid, scenario2, site=omsite)
model2_flows.df <- data.frame(model2_flows)
model2_flows <- zoo(as.numeric(as.character(model2_flows$Qout)), order.by = index(model2_flows))
```

```{r get_vahydro_stats, include=FALSE}
#Pull pre-calculated stats
sc1_l90_Qout <- model1_info[[1]][[scenario1]]$l90_Qout$value
sc1_l30_Qout <- model1_info[[1]][[scenario1]]$l30_Qout$value
sc1_l90_year <- model1_info[[1]][[scenario1]]$l90_year$value
sc1_l30_year <- model1_info[[1]][[scenario1]]$l30_year$value
sc1_Qbaseline <- model1_info[[1]][[scenario1]]$Qbaseline$value
sc1_Qout <- model1_info[[1]][[scenario1]]$Qout$value
sc1_7q10 <- model1_info[[1]][[scenario1]]$'7q10'$value
sc1_mne9_10 <- model1_info[[1]][[scenario1]]$mne9_10$value
sc1_ml8 <- model1_info[[1]][[scenario1]]$ml8$value
sc1_ps_mgd <- model1_info[[1]][[scenario1]]$ps_mgd$value
sc1_ps_cumulative_mgd <- model1_info[[1]][[scenario1]]$ps_cumulative_mgd$value
sc1_wd_cumulative_mgd <- model1_info[[1]][[scenario1]]$wd_cumulative_mgd$value
sc1_wd_mgd <- model1_info[[1]][[scenario1]]$wd_mgd$value
sc1_unmet_demand_mgd <- model1_info[[1]][[scenario1]]$unmet_demand_mgd$value
sc1_ps_nextdown_mgd <- model1_info[[1]][[scenario1]]$ps_nextdown_mgd$value
sc1_consumptive_use_frac <- model1_info[[1]][[scenario1]]$consumptive_use_frac$value
sc1_daily_consumptive_use_frac <- model1_info[[1]][[scenario1]]$daily_consumptive_use_frac$value
sc1_net_consumption_mgd <- model1_info[[1]][[scenario1]]$net_consumption_mgd$value
################################################################################
sc2_l90_Qout <- model2_info[[1]][[scenario2]]$l90_Qout$value
sc2_l30_Qout <- model2_info[[1]][[scenario2]]$l30_Qout$value
sc2_l90_year <- model2_info[[1]][[scenario2]]$l90_year$value
sc2_l30_year <- model2_info[[1]][[scenario2]]$l90_year$value
sc2_Qbaseline <- model2_info[[1]][[scenario2]]$Qbaseline$value
sc2_Qout <- model2_info[[1]][[scenario2]]$Qout$value
sc2_7q10 <- model2_info[[1]][[scenario2]]$'7q10'$value
sc2_mne9_10 <- model2_info[[1]][[scenario2]]$mne9_10$value
sc2_ml8 <- model2_info[[1]][[scenario2]]$ml8$value
sc2_ps_mgd <- model2_info[[1]][[scenario2]]$ps_mgd$value
sc2_ps_cumulative_mgd <- model2_info[[1]][[scenario2]]$ps_cumulative_mgd$value
sc2_wd_cumulative_mgd <- model2_info[[1]][[scenario2]]$wd_cumulative_mgd$value
sc2_wd_mgd <- model2_info[[1]][[scenario2]]$wd_mgd$value
sc2_unmet_demand_mgd <- model2_info[[1]][[scenario2]]$unmet_demand_mgd$value
sc2_ps_nextdown_mgd <- model2_info[[1]][[scenario2]]$ps_nextdown_mgd$value
sc2_consumptive_use_frac <- model2_info[[1]][[scenario2]]$consumptive_use_frac$value
sc2_daily_consumptive_use_frac <- model2_info[[1]][[scenario2]]$daily_consumptive_use_frac$value
sc2_net_consumption_mgd <- model2_info[[1]][[scenario2]]$net_consumption_mgd$value
```
