...
## Flow Duration Curve
```{r FDCRetrieve, echo = FALSE, eval=FALSE, message = FALSE, results = "asis", fig.cap=paste("Flow duration curves from VAHydro:", title_param), fig.id = "fdc", fig.cap.style = "Image Caption", out.width = '100%'}
...
```{r AllFlowsRetrieve, echo = FALSE, eval=FALSE, message = FALSE, results = "asis", fig.cap=paste("Discharge, point sources, and withdrawals from VAHydro:", title_param), fig.id = "all_flows", fig.cap.style = "Image Caption", out.width = '100%'}
...
```{r DryRetrieve, echo = FALSE, eval=FALSE, message = FALSE, results = "asis", fig.cap=paste("The dry periods from VAHydro:", title_param), fig.id = "dry_periods", fig.cap.style = "Image Caption", out.width = '100%'}
...
```{r L902YRetrieve, echo = FALSE, eval=FALSE, message = FALSE, results = "asis", fig.cap=paste("The 2 year, 90-day low flows from VAHydro:", title_param), fig.id = "2yr_l90", fig.cap.style = "Image Caption", out.width = '100%'}
...
```{r 90day, echo = FALSE, eval = FALSE, fig.cap=paste("The 90-day low flows:", title_param), fig.id = "90day", fig.cap.style = "Image Caption"}
for (r in 1:length(rseg.model.version)) {
  if (r == 1) {
...
```{r 30day, echo = FALSE, eval = FALSE, fig.cap=paste("The 30-day low flows:", title_param), fig.id = "30day", fig.cap.style = "Image Caption"}
for (r in 1:length(rseg.model.version)) {
  if (r == 1) {
...
```{r 1day, echo = FALSE, eval = FALSE, fig.cap=paste("The 1-day low flows:", title_param), fig.id = "1day", fig.cap.style = "Image Caption"}
for (r in 1:length(rseg.model.version)) {
  if (r == 1) {
...
for (r in 2:length(rseg.model.version)) { 
  ...
  metric_table$pct_diff <- as.numeric(round((as.numeric(metric_table$diff) / as.numeric(metric_table[,2])), digits = 4)*100) #conv to % diff
