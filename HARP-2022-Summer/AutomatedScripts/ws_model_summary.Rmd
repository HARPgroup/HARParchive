...
for (r in 1:length(rseg.model.version)) {
  if (r == 1) {
    ...
    colname.l90 <- paste0("rseg.l90.", r)
  } else {
    l90.data <- cbind(l90.data, rseg.lowflow.r["90 Day Min"])
    colnames(l90.data) <- c("year", colname.l90, paste0("rseg.l90.", r))
    ymax.l90 <- max(l90.data[-1])
  }
}

# l90.plot <- ggplot(data=l90.data, aes(x=year, y=l90.data[-1], ymax = ymax.l90, validate_mapping = )) + 
#   geom_col(position_dodge2(preserve ="single", padding ="0.001"))+
#   theme_minimal()
...
for (r in 1:length(rseg.model.version)) {
  if (r == 1) {
    ...
    colname.l30 <- paste0("rseg.l30.", r)
  } else {
    l30.data <- cbind(l30.data, rseg.lowflow.r["30 Day Min"])
    colnames(l30.data) <- c("year", colname.l30, paste0("rseg.l30.", r))
...
for (r in 1:length(rseg.model.version)) {
  if (r == 1) {
    ...
    colname.l7 <- paste0("rseg.l7.", r)
  } else {
    l7.data <- cbind(l7.data, rseg.lowflow.r["7 Day Min"])
    colnames(l7.data) <- c("year", colname.l7, paste0("rseg.l7.", r))
