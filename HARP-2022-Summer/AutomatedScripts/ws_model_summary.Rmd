...
for (r in 1:length(rseg.model.version)) {
  ...
  ftable <- data.frame(matrix(nrow=0, ncol=4)) #create empty data frame to add rows we're keeping (otherwise row numbers get scrambled in the for-loop)
