...
if (length(rseg.model.version) == 2) {
  perc.diff.data <- cbind(mean_diff_pct.2, l90_diff_pct, l30_diff_pct, l7_diff_pct, l1_diff_pct)
...
if (length(rseg.model.version) == 3) {
  ...
  colnames(perc.diff.data.2) <- c("Mean Flow", "l90", "l30", "l7", "l1") 
}
...
# if (length(rseg.model.version) == 3) {
#   legend_colors <- c("Model 2" = "blue", "Model 3" = "red")
#   perc.diff.fig <- perc.diff.fig +
#     geom_boxplot(stack(perc.diff.data.2), mapping = aes(x = ind, y = values,
#                                                         color = "Model1 - Model3")) +
#     geom_boxplot(outlier.colour="red", outlier.shape=8,
#                   outlier.size=3, position = position_dodge(width = 0.5)) +
#     stat_boxplot(geom ='errorbar') +
#     stat_summary(fun.data = fun_median, geom="text", vjust=0.7, 
#                  aes(label=round(..y.., digits = 5), group = "Model 3")) +
#     labs(color = "% Diff:") + 
