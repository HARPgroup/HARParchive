...
params: 
  ...
  ftable.submod:  [ ] #either p6 or p532, p6 will have /vadeq added automatically
  ftable.id: [ ] #after /river/ and before /ftables in path
  rseg: [ ] #needed to pull LEN from ftable HYDR file?
