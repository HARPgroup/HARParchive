...
```{r FDC2, out.width=paste0("1/",r), fig.align='center', fig.cap=paste("Flow duration curves from VAHydro:", ftext.model[1]), fig.id = "fdc", fig.cap.style = "Image Caption", echo = FALSE}
# for (r in 1:length(rseg.model.version)) {
#   runid.r <- runid.list[r]
#   rseg.runid.r <- dat[[r]][[runid.r]]
#   path.fdc.r <- rseg.runid.r[['fig.fdc']][['code']]
#
  # knitr::include_url(path.fdc.r)
  # external_img(path.fdc.r, width = 1/r)
  # if (r == 1) {
  #     fig.fdc <- path.fdc.r
  #   } else {
  #     fig.fdc <- list(fig.fdc, path.fdc.r)
  #   }
#}
# knitr::include_url(fig.fdc)
```
