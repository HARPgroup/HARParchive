...
## Flow Duration Curve
```{r FDCRetrieve, echo = FALSE, message = FALSE, results = "asis", fig.cap=paste("Flow duration curves from VAHydro:", ftext.model[1]), fig.id = "fdc", fig.cap.style = "Image Caption"}
for (r in 1:length(rseg.model.version)) {
  runid.r <- runid.list[r]
...
```{r AllFlowsRetrieve, echo = FALSE, message = FALSE, results = "asis", fig.cap=paste("Discharge, point sources, and withdrawals from VAHydro:", ftext.model[1]), fig.id = "all_flows", fig.cap.style = "Image Caption"}
for (r in 1:length(rseg.model.version)) {
  runid.r <- runid.list[r]
  rseg.runid.r <- dat[[r]][[runid.r]]
...
```{r DryRetrieve, echo = FALSE, message = FALSE, results = "asis", fig.cap=paste("The dry periods from VAHydro:", ftext.model[1]), fig.id = "dry_periods", fig.cap.style = "Image Caption"}
for (r in 1:length(rseg.model.version)) {
  runid.r <- runid.list[r]
  rseg.runid.r <- dat[[r]][[runid.r]]
...
```{r L902YRetrieve, echo = FALSE, message = FALSE, results = "asis", fig.cap=paste("The 2 year, 90-day low flows from VAHydro:", ftext.model[1]), fig.id = "2yr_l90", fig.cap.style = "Image Caption"}
for (r in 1:length(rseg.model.version)) {
  runid.r <- runid.list[r]
  rseg.runid.r <- dat[[r]][[runid.r]]
...
```{r 30day, echo = FALSE, fig.cap=paste("The 30-day low flows:", ftext.model[1]), fig.id = "30day", fig.cap.style = "Image Caption"}
for (r in 1:length(rseg.model.version)) {
  if (r == 1) {
...
```{r 7day, echo = FALSE, fig.cap=paste("The 7-day low flows:", ftext.model[1]), fig.id = "7day", fig.cap.style = "Image Caption"}
for (r in 1:length(rseg.model.version)) {
  if (r == 1) {
...
```{r 1day, echo = FALSE, fig.cap=paste("The 1-day low flows:", ftext.model[1]), fig.id = "1day", fig.cap.style = "Image Caption"}
for (r in 1:length(rseg.model.version)) {
  if (r == 1) {
