...
for (r in 1:length(rseg.model.version)) {
  ...
  ftable$x <- ftable$area * 43560 / length / 2 #divide by 2 to get 1/2 the surface width (middle of plot is x=0 -> sw is -x to x)
...
persp(as.numeric(rownames(z)), as.numeric(colnames(z)), z, theta = 5, phi = 15, expand = .2, col = "#0099CC", axes=TRUE, nticks=8, ticktype="detailed", scale=TRUE, shade=0.65, border="003300", d=0.6, r=9, xlab="Width (ft)",
  ...
  for(i in 1:15){
    lines (trans3d(x = c(-ftable$x[i], ftable$x[i]), y = seq(0, length, by=10) , z = ftable$depth[i], pmat = channel), 
...
persp(as.numeric(rownames(z)), as.numeric(colnames(z)), z, theta = 10, phi = 15, expand = .2, col = "#0099CC", axes=TRUE, nticks=8, ticktype="detailed", scale=TRUE, shade=0.65, border="003300", d=0.6, r=9, xlab="Width (ft)", ylab="Channel Length (ft)", zlab="Depth (ft)", main=paste(model.comparison[1,2], "Cross-section"), sub=paste("Bankfull Depth is approx.", ftable$depth[10], "ft"))

persp(as.numeric(rownames(z)), as.numeric(colnames(z)), z, theta = -5, phi = -15, expand = .2, col = "#0099CC", axes=TRUE, nticks=8, ticktype="detailed", scale=TRUE, shade=0.65, border="003300", d=0.6, r=9, xlab="Width (ft)", ylab="Channel Length (ft)", zlab="Depth (ft)", main=paste(model.comparison[1,2], "Cross-section"), sub=paste("Bankfull Depth is approx.", ftable$depth[10], "ft"))
