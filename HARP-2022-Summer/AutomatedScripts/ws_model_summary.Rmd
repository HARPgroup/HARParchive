...
cat(fig.fdc)
```
```{r FDC2, out.width=paste0("1/",r), fig.align='center', fig.cap=paste("Flow duration curves from VAHydro:", caption), fig.id = "fdc", fig.cap.style = "Image Caption", echo = FALSE}
# for (r in 1:length(rseg.model.version)) {
#   runid.r <- runid.list[r]
#   rseg.runid.r <- dat[[r]][[runid.r]]
#   path.fdc.r <- rseg.runid.r[['fig.fdc']][['code']]
