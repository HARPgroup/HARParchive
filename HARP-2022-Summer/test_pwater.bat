...
Rscript HARParchive/HARP-2022-Summer/AutomatedScripts/export_hsp_h5.R $h5_file_path 
$output_file_path $data_source_table

Rscript HARParchive/HARP-2022-Summer/AutomatedScripts/hsp_pwater.R $land_segment $scenario_name 
$landuse $output_file_path $image_file_path

Rscript HARParchive/HARP-2022-Summer/AutomatedScripts/hsp_pwater_stats.R $land_segment 
$scenario_name $landuse $output_file_path $image_file_path
