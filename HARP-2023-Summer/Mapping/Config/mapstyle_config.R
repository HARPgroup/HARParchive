  ...
  wsp_2020_2040 = list(
    riverseg_metrics=list( 
      ...
      list(
        metric='l90_Qout', 
        data_set = 'rseg_no_geom',
        column_name='percentDiff_l90_cc_Qout_runid_11_runid_17', 
        run_label = '90 Day Low Flow (Percent Change 2020 to Dry Climate Scenario)', 
        show_map = TRUE,
        ramp = 'default',
        tables_cols = c('name', 'riverseg', 'Metric', 'runid_11_l90_cc_Qout','runid_17_l90_cc_Qout', 'percentDiff_l90_cc_Qout_runid_11_runid_17'),
        sort_col = 'percentDiff_l90_cc_Qout_runid_11_runid_17',
        floor = NULL, 
        ceiling = NULL, 
        n_entries = 999,
        sort = 'increasing',
      ...
      list(
        ...
        sort_col = 'percentDiff_l30_cc_Qout_runid_11_runid_17',
        floor = NULL, 
        ceiling = NULL, 
        n_entries = 999,
        sort = 'increasing',
...
readable <- data.frame(rbind(
  ...
  c('wd_mgd', 'Withdrawals (MGD)'),
  c('gw_demand_mgd', 'Ground Water Demand (MGD)'),
  c('ps_mgd', 'Point Source (MGD)'),
  c('wsp2020_2040_mgy', 'Water Supply Plan 2040 Demand (MGY)'),
  ...
  c('runid_11_wd_mgd', '2020 Demand Scenario Withdrawals (MGD)'),
  c('runid_13_wd_mgd', '2040 Demand Scenario Withdrawals (MGD)'),
  c('runid_11_l90_Qout', '2020 90 Day Low Flow (cfs)'),
  c('runid_13_l90_Qout', '2040 90 Day Low Flow (cfs)'),
  c('runid_11_l30_cc_Qout', '2020 30 Day Low Flow (cfs)'),
  c('runid_11_l90_cc_Qout', '2020 90 Day Low Flow (cfs)'),
  c('runid_13_l90_cc_Qout', '2040 90 Day Low Flow (cfs)'),
  ...
  c('runid_1000_Qout', 'Baseline Flow (cfs)'),
  c('runid_17_l90_cc_Qout', '2040 Dry Climate Scenario 90 Day Low Flow (cfs)'),
  c('runid_17_l30_cc_Qout', '2040 Dry Climate Scenario 30 Day Low Flow (cfs)'),
  c('percentDiff_l90_cc_Qout_runid_11_runid_17', 'Percent Difference in 90 Day Low Flow From 2020-2040 (Dry Climate Scenario)'),
  c('percentDiff_l30_cc_Qout_runid_11_runid_17', 'Percent Difference in 30 Day Low Flow From 2020-2040 (Dry Climate Scenario)'),
  c('runid_17_7q10', '2040 Dry Climate Scenario 7Q10 (cfs)'),
  ...
  c('runid_17_unmet30_mgd', '2040 Dry Climate Scenario 30 day Potential Unmet Demand (MGD)'),
