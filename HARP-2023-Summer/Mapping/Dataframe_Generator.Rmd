...
#----Pull Data----
#---Facility Data--- #changed for analysts foundation location
foundatn_mp <- fread(paste0(foundation_location, "foundation_dataset_mgy.csv")) #foundational measuring pt(mp)/sources data
...
if (featr_type=="facility") { #specified model metrics will be pulled @ the facility-level for every specified runid using om_vahydro_metric_grid()
  ...
  f_geo <- fread(paste0(foundation_location , "facilities_all_geom.csv")) #changed for analysts foundation location
} 
