...
rsegs <- read.csv("C:/Users/ejp42531/Documents/github/HARParchive/HARP-2023-Summer/Mapping/Data/rseg_geom.csv") 
...
if(featr_type == "facility"){ #get facility-level fiveyr_avg_mgy from foundatn_mp by summing all mp values for each facility:
  f_foundatn <- sqldf("
   SELECT facility_hydroid,facility,Use_Type,latitude,longitude,fips_code,locality,ows_planner,facility_status,
    Total_Permit_Limit_MGY,gw_frac,wsp_2040_mgy,wsp2020_2040_mgy,fac_CEDSid,
