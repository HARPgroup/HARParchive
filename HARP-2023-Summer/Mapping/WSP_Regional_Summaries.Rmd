...
params: 
  ...
  featrs_file: "C:/aa_HARP/Exports/Roanoke_1_featrs_sf.csv"
  ...
  rsegs_file: "C:/aa_HARP/Exports/Roanoke_1_rsegs_sf.csv"
...
if (show_map == TRUE) {
  rm(maplabs)
  maplabs <- fn_labelprep(data=list(counties, cities, roads, nhdlabs), classes=c("county","city","road","nhd"), label_storage_name="maplabs")
}
```
   ...
   if (i==1) { #data for table will be sorted by the first of featrs_file_map_bubble_column
    ...
    #suppressWarnings(suppressMessages( 
      ...
      map <- fn_mapgen(bbox, crs_default, metric_unit, mp_layer, featr_type, 
                       maptitle, mapnum=1, rseg_leg_title=NULL, map_server, map_layer, maplabs, 
                       nhd, roads, rsegs, rsegs_sf, map_style, styles)
