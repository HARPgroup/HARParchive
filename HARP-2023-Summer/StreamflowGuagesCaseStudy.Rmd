...
boxplot(RRwinter, ylab = 'Monthly magnitude (cfs)', ylim(0,1000), main = 'Monthly Mean Winter')
boxplot(RRspring, ylab = 'Monthly magnitude (cfs)', ylim(0,1000), main = 'Monthly Mean Spring')
```
