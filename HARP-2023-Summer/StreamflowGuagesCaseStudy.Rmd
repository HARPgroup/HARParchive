...
spring23 <- springFlows %>% filter(year==2023) # finding avg for this years flow
winter23 <- winterFlows %>% filter(year==2023)
spring23avg <- mean(spring23$flow)
winter23avg <- mean(winter23$flow)
