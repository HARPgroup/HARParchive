...
boxplot(RRwinter$WmonthMean, ylab = 'Monthly magnitude (cfs)', main = 'Monthly Mean Winter', col='#FC4E07', ylim= c(0,10000))
boxplot(RRspring$SmonthMean, ylab = 'Monthly magnitude (cfs)', main = 'Monthly Mean Spring', col='#00AFBB', ylim= c(0,10000))
```
...
*Best Gauge(Highest Percentile)- Clinch 1
  +Winter: -15.3%
  +Spring: 15%
*Worst Gauge(Lowest Percentile)- Shenandoah
  +Winter: -42.8%
  +Spring: -30.1%
