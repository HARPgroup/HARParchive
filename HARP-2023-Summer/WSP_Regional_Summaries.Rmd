...
ft1 <- fn_tablegen(type = "facility", table = table, alignment = "left") #Execute flextable function, which saves the flextable as variable 'ft' for displaying later
```
...
for (k in 1:length(rivseg_metric)){
  ...
  ft2 <- fn_tablegen(type = "riverseg", table = rivdf, alignment = "left") #Flextable function
