...
params: 
  ...
  facils_file: "C:/HARP/Exports/JL6_7320_7150_facils_sf3.csv"
  facils_file_map_bubble_column: ["runid_11_wd_mgd"]
  facils_file_table_column: ["runid_11_wd_mgd","runid_13_wd_mgd","fiveyr_avg_mgy","wsp2020_2040_mgy"]

  rsegs_file: "C:/HARP/Exports/JL6_7320_7150_rsegs3_sf.csv"
  ...
  locality: ["Fairfax"]
  region: ["UpperJames_1"]    
  map_type: ["locality"] #one of: basin, locality, or region 
  ...
  regions_file : "C:/HARP/Exports/regions_sf.csv"
  # asthetic changes
...
ft1 <- fn_tablegen(type = "facility", table = table, columns = "all", alignment = "left", map_type,metric = rivseg_metric[i], rivseg, title="default" ) #Execute flextable function, which saves the flextable as variable 'ft' for displaying later
