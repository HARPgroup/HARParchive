...
```{r Pull Facility Permitted Capacity, echo=FALSE, message=FALSE, warning=FALSE}
#facils$within currently has multiple 'duplicated' facility rows for facils with multiple vahydro-1.0 features 
#need to pull & join permitted capacity for each of these ^, including the so-called duplicates
#perm capac (vwp_max) is not within a runid scenario, but attatched directly to facil-model element 
