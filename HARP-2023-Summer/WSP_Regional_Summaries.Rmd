...
params: 
  ...
  origin: ["JL7_7070_0001"] #supply either a rivseg, locality, or region name
...
##Mapping function
  ...
  # args/params have been kept separate during dev. so far, but will be consolidated & some removed once we're happy with maps 
     ...
     fn_mapgen2(mapnum = 1, featr_type, origin_type, styles[[map_style]], metric = featrs_file_map_bubble_column[i], origin, bbox, rsegs, counties, roads, 
           nhd, maplabs, mp_layer, metric_unit, title=title) ))
