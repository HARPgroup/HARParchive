...
#determining what metric(s) will be pulled and mapped
  ...
  map_by: ["runid_13_wd_mgd"] #the metric(s) for mapping, which the bubbles & legend will be scaled to. Ex: runid_11_wd_mgd, fiveyr_avg_mgy
...
for (i in 1:length(rivseg_metric)){
  ...
  if (rivseg_metric[i]=="l30_Qout"){
      title <- gsub("l30_Qout", "30 Day Low Flow", title1)
  }
  else if (rivseg_metric[i]=="l90_Qout"){
          title <- gsub("l90_Qout", "90 Day Low Flow", title1)
  }
  else if (rivseg_metric[i]=="7q10"){
      title <- gsub("7q10", "7 Day Low Flow", title1)
  }
  else {
    title <- title1
  }
