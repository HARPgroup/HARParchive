...
#downstream datframes are not sorted correctly 
#the ds_seg strings within the loop are in the correct order 
...
#New graph idea: Qavailable vs Qdemand vs Qbaseline
