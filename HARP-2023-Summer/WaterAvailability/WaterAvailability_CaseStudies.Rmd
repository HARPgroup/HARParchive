...
for (i in 1:length(outlet_list)) {
  ...
  plot30 <- ggplot(data = get(paste0('caseStudy_wshed_df_',i)), aes(x= reorder(riverseg, NUM))) +
    ...
    plot30_filename[i] <- paste0(export_path, 'WAcaseStudies_Plot_', i, '_', outlet_list[i], '_QvsQavail_L30.png')
    ggsave( #save image of plot
 ...
 plot90 <- ggplot(data = get(paste0('caseStudy_wshed_df_',i)), aes(x= reorder(riverseg, NUM))) +
    ...
    plot90_filename[i] <- paste0(export_path, 'WAcaseStudies_Plot_', i,'_', outlet_list[i], '_QvsQavail_L90.png')
    ggsave( #save image of plot
      filename = plot90_filename[i],
      plot = plot90,
      width = 25,
      height = 20)
...
WAmapfilename30 <- character()
WAmapfilename90 <- character()
for (i in 1:length(outlet_list)) {
  ...
  #save image of L30 map
  WAmapfilename30[i] <- paste(export_path, "WAcaseStudiesMapL30_", i, "_", outlet_list[i], ".png", sep="")
  ggsave(
    filename = WAmapfilename30[i],
    plot = map30,
    width = 25,
    height = 20)
  ...
  #save image of L30 map
  WAmapfilename90[i] <- paste(export_path, "WAcaseStudiesMapL90_", i, "_", outlet_list[i], ".png", sep="")
  ggsave(
    filename = WAmapfilename90[i],
    plot = map90,
    width = 25,
    height = 20)
