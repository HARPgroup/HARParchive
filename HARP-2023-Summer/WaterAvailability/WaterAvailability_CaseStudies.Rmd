...
for (i in 1:length(outlet_list)) { 
  ...
  if ("github" %in% write_tables) {
    write.csv(table_caseStudyWshed, paste0(github_location, 
                                           '/HARParchive/HARP-2023-Summer/WaterAvailability/CaseStudiesTables/CSVs/CaseStudies_table6.', i, 
...
# Table 7: L30/L90 Specific Case Study Watershed Tables 

```{r L30/L90 Case Study Watershed Tables}
...
for (i in 1:length(outlet_list)) { 
  ...
  if ("local" %in% write_tables) {
    write.csv(table_cswsL30, paste0(export_path, 
                                           'CaseStudies_table7.', i, '_CaseStudyWshed_L30_', 
                                           outlet_list[i], '_', 
                                           demand_scenario, '_', baseline_scenario, 
                                           '_', mif_coef, '.csv')) #write table locally
    write.csv(table_cswsL90, paste0(export_path, 
                                           'CaseStudies_table7.', i, '_CaseStudyWshed_L90_', 
                                           outlet_list[i], '_', 
                                           demand_scenario, '_', baseline_scenario, 
                                           '_', mif_coef, '.csv')) #write table locally
  }
  ...
  if ("github" %in% write_tables) {
    write.csv(table_cswsL30, paste0(github_location, 
                               '/HARParchive/HARP-2023-Summer/WaterAvailability/CaseStudiesTables/CSVs/CaseStudies_table7.', i, '_CaseStudyWshed_L30_', 
    ...
    write.csv(table_cswsL90, paste0(github_location, 
                               '/HARParchive/HARP-2023-Summer/WaterAvailability/CaseStudiesTables/CSVs/CaseStudies_table7.', i, '_CaseStudyWshed_L90_', 
                               outlet_list[i], '_', demand_scenario, '_', baseline_scenario, '_', mif_coef, '.csv')) #write table to GitHub
  }
