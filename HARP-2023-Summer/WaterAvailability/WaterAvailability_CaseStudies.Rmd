...
```{r Get Complete List of Rsegs, echo=FALSE}
#Get rsegs 
df_rsegs <- data.frame(
  'model_version' = c('vahydro-1.0', 'vahydro-1.0'),
  'runid' = c(demand_scenario, demand_scenario),
...
rsegs <- data.frame(riverseg = unique(rsegs_data$riverseg))
```

```{r Get rid of waterSupplyElements from Storage data, echo=FALSE, message=FALSE}
