...
title_table_WA <- paste0('TABLE 1: WATER AVAILABILITY. Demand: ', demand_scenario, ', Baseline: ', baseline_scenario, ', MIF: ', instream_coeff)
...
table_WA <- data.frame(Propname = df_WA$propname,
                     ...
                     l30_Qout_mif = round((df_WA$l30_Qout_base*instream_coeff), digits = 3),
                     l90_Qout = round(df_WA$l90_Qout_dem, digits = 3),
                     l90_Qout_base = round(df_WA$l90_Qout_base, digits = 3),
                     l90_Qout_mif = round((df_WA$l90_Qout_base*instream_coeff), digits = 3),
...
title_table_Smin <- paste0('TABLE 2: SMIN DISCREPANCIES. Demand: ', demand_scenario, ', Baseline: ', baseline_scenario, ', MIF: ', instream_coeff)
...
title_table_Storage <- paste0('TABLE 3: SMIN METHOD COMPARISON. Demand: ', demand_scenario, ', Baseline: ', baseline_scenario, ', MIF: ', instream_coeff)
...
title_table_imp <- paste0('TABLE 4: IMPOUNDMENTS OF INTEREST. Demand: ', demand_scenario, ', Baseline: ', baseline_scenario, ', MIF: ', instream_coeff)
...
```{r Table 5, echo = FALSE, message=FALSE}
title_table_ups <- paste0('TABLE 5: WA UPSTREAM OF IMPOUNDMENTS OF INTEREST. Demand: ', demand_scenario, ', Baseline: ', baseline_scenario, ', MIF: ', instream_coeff)
...
table_ups <- data.frame(Propname = ups_df$propname,
                     ...
                     l30_Qout_mif = round((ups_df$l30_Qout_base*instream_coeff), digits = 3),
                     l90_Qout = round(ups_df$l90_Qout_dem, digits = 3),
                     l90_Qout_base = round(ups_df$l90_Qout_base, digits = 3),
                     l90_Qout_mif = round((ups_df$l90_Qout_base*instream_coeff), digits = 3),
