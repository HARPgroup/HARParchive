...
params: 
  ...
  mif_coef: [0.9]
  Smin_analysis: FALSE #to compare Smin calculation methods: approximate and near-exact (adds tables 5 & 6)
...
for (i in 1:length(outlet_list)) { 
  ...
  colnum_csL30 <- which(colnames(table_cswsL30) == "Water Availability (mgd)") #get col number for WA
  ...
  colnum_csL90 <- which(colnames(table_cswsL90) == "Water Availability (mgd)") #get col number for WA
...
for (i in 1:length(outlet_list)) {
  ...
  if ("local" %in% write_tables) { #save image of plot locally
  ...
  if ("github" %in% write_tables) { #save image of plot to GitHub
...
for (i in 1:length(outlet_list)) {
  ...
  if ("local" %in% write_tables) { #save image of L30 map locally
  ...
  if ("github" %in% write_tables) { #save image of L30 map to GitHub
  ...
  assign(paste0('map90', i), map90, envir = globalenv())
   ...
   if ("local" %in% write_tables) { #save image of L90 map locally
  ...
  if ("github" %in% write_tables) { #save image of L90 map to GitHub
