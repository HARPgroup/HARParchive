...
params: 
  ...
  mif_coef: [0.9]
  Smin_analysis: TRUE #to compare Smin calculation methods: approximate and near-exact
...
for (i in 1:length(outlet_list)) { 
  ...
  names(table_cswsL30)[names(table_cswsL30) == "Num"] <- "#"
  names(table_cswsL30)[names(table_cswsL30) == "wd_cumulative_mgd"] <- "Cumulative Withdrawal (mgd)"
  names(table_cswsL30)[names(table_cswsL30) == "ps_cumulative_mgd"] <- "Cumulative Point Source (mgd)"
  names(table_cswsL30)[names(table_cswsL30) == "l30_Qout_mgd"] <- "Lowest 30-Day Demand Flow (mgd)"
  names(table_cswsL30)[names(table_cswsL30) == "l30_Qout_base_mgd"] <- "Lowest 30-Day Base Flow (mgd)"
  names(table_cswsL30)[names(table_cswsL30) == "l30_Qout_mif_mgd"] <- "Min. Instream Flow (mgd)"
  names(table_cswsL30)[names(table_cswsL30) == "Qavailable_30_mgd"] <- "Available Flow (mgd)"
  names(table_cswsL30)[names(table_cswsL30) == "SminL30mg_local"] <- "Local Storage (mg)"
  names(table_cswsL30)[names(table_cswsL30) == "SminL30mg_upstream"] <- "Upstream Storage (mg)"
  names(table_cswsL30)[names(table_cswsL30) == "SminL30mg_total"] <- "Total Storage (mg)"
  names(table_cswsL30)[names(table_cswsL30) == "WA_mgd_30"] <- "Water Availability (mgd)"
  
  ftable_cswsL30 <- flextable(table_cswsL30)
  ...
  #Human readable column names 
  names(table_cswsL90)[names(table_cswsL90) == "Num"] <- "#"
  names(table_cswsL90)[names(table_cswsL90) == "wd_cumulative_mgd"] <- "Cumulative Withdrawal (mgd)"
  names(table_cswsL90)[names(table_cswsL90) == "ps_cumulative_mgd"] <- "Cumulative Point Source (mgd)"
  names(table_cswsL90)[names(table_cswsL90) == "l90_Qout_mgd"] <- "Lowest 90-Day Demand Flow (mgd)"
  names(table_cswsL90)[names(table_cswsL90) == "l90_Qout_base_mgd"] <- "Lowest 90-Day Base Flow (mgd)"
  names(table_cswsL90)[names(table_cswsL90) == "l90_Qout_mif_mgd"] <- "Min. Instream Flow (mgd)"
  names(table_cswsL90)[names(table_cswsL90) == "Qavailable_90_mgd"] <- "Available Flow (mgd)"
  names(table_cswsL90)[names(table_cswsL90) == "SminL90mg_local"] <- "Local Storage (mg)"
  names(table_cswsL90)[names(table_cswsL90) == "SminL90mg_upstream"] <- "Upstream Storage (mg)"
  names(table_cswsL90)[names(table_cswsL90) == "SminL90mg_total"] <- "Total Storage (mg)"
  names(table_cswsL90)[names(table_cswsL90) == "WA_mgd_90"] <- "Water Availability (mgd)"
  
  ftable_cswsL90 <- flextable(table_cswsL90)
