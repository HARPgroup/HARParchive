...
#Human readable column names for flextable 
names(table_caseStudiesHr)[names(table_caseStudiesHr) == "SminL30mg_apx"] <- "30-Day Storage (mg)"
names(table_caseStudiesHr)[names(table_caseStudiesHr) == "SminL90mg_apx"] <- "90-Day Storage (mg)"
