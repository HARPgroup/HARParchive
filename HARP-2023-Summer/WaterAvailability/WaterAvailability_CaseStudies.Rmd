...
for (i in 1:nrow(caseStudies_df)) { 
  if (!caseStudies_df$riverseg[i] %in% c("OR3_7740_8271_carvins", "YP2_6390_6330")) { #don't do tradition upstream process for carvins cove or lake anna
  ...
  } else { #carvins and lake anna special case
...
# Table 1: Smin Method Comparison
...
# Table 2: Smin Method Discrepancies
...
# Table 3: Smins that Need to be Updated
...
for (i in 1:nrow(caseStudies_df)) { 
  title_table_caseStudyWshed <- paste0('TABLE 5: CASE STUDY WATERSHEDS. Demand: ', 
...
# Table 6: Overall Water Availability Across VA
