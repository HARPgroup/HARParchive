...
#create empty columns to hold near exact storage values 
storage_data$SminL30mg_nex <- NA
...
for (i in 1:nrow(storage_data)) {
  ...
  storage_data$SminL30mg_nex[i] <- min(l30pd_df$Storage) / 3.069
  storage_data$SminL90mg_nex[i] <- min(l90pd_df$Storage) / 3.069
