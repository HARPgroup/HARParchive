...
params: 
  ...
  outlet_list: ["PL3_5360_5250", "JU4_7000_7300", "JA5_7480_0001", "YP3_6670_6720", "OR3_7740_8271", "PU4_3970_3890", "NR6_7960_8050"]
...
for (i in 1:nrow(caseStudies_df)) {
  ...
  ### Move case study names to subtitle
  ...
  plot30 <- ggplot(data = get(paste0('ups_ds_df_',i)), aes(x=riverseg)) +
    ...
    labs(title = 'Qdemand vs Qavailable (L30)',
       subtitle = paste0("For ", caseStudyName, "<br> Qavailable = Qdemand - MIF*Qbaseline"))
...
for (i in 1:nrow(caseStudies_df)) {
  ...
  map <- ggplot(rsegs_bbox) + geom_sf(fill = "grey") + #map all segments within bbox as background
    ...
    theme(plot.title = element_text(size = 40), legend.text = element_text(size = 25), legend.title = element_text(size = 30)) + 
