...
# L30/L90 Specific Case Study Watershed Tables 

```{r L30/L90 Case Study Watershed Tables}
#for displaying alongside water availability maps, not saved 
...
crs_default <- 4326 #move to params
...
for (i in 1:length(caseStudy_list)){
  ...
  #L90 map
  fig_L30 = paste(paste0("![](",WAmapfilename90[i],")"),"\n")
  cat(fig_L30)
