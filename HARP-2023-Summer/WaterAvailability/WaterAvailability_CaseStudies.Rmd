...
df1 <- sqldf("SELECT a.* FROM metric_data as a WHERE Sminl30mg_apx_total IS NOT 0")

table1 <- data.frame(propname = df1$propname,
                     riverseg = df1$riverseg,
                     l30_Qout = df1$l30_Qout_dem,
                     l90_Qout = df1$l90_Qout_dem,
                     l30_Qout_base = df1$l30_Qout_base,
                     l90_Qout_base = df1$l90_Qout_base,
                     SminL30mg_apx = df1$SminL30mg_apx_total,
                     SminL90mg_apx = df1$SminL90mg_apx_total,
                     SminL30mg_nex = df1$SminL30mg_nex_total,
                     SminL90mg_nex = df1$SminL90mg_nex_total,
                     WA_mgd_30_apx = df1$WA_mgd_30_apx,
                     WA_mgd_90_apx = df1$WA_mgd_90_apx,
                     WA_mgd_30_nex = df1$WA_mgd_30_nex,
                     WA_mgd_90_nex = df1$WA_mgd_90_nex)
