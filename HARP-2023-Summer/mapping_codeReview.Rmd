...
source(paste0(getwd(), '/', 'fn_mapgen_est.R' )) #load script with function
fn_mapgen(rivseg, basemap, basemap_0, segs, facils, counties, roads, nhd, labelsP)
```

```{r}
### Saving test map from function 
ggsave(
