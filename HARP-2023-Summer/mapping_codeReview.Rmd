...
## Only run 1 of next 2 chunks: 2 different optins for bbox creation

```{r, warning=FALSE}
## EITHER generate bbox from basin geometry
...
```{r}
## OR retrieve bbox from vahydro property
...
```{r}
## Remove city/town names that match their county/locality name -- for clean mapping

#ADJUST WITH NEW CITY CSV
cities <- sqldf( 
  "SELECT cities.*  
   FROM cities
