...
params:
  rivseg: ["JL6_7320_7150"] #["JA4_7280_7340" , "JB3_6820_7053","JL6_7320_7150", "JL7_7070_0001"]  <-last=Richmond
...
segs <- list()
segs$all <- download_read(url=paste(site,"/vahydro_riversegs_export",sep=""), filetype="csv") ##TEMPORARY work-around
...
roads <- list()
roads$state <- download_read(url="https://www2.census.gov/geo/tiger/TIGER2022/STATE/tl_2022_us_state.zip", filetype="shp")
...
map <- basemap + #ggplot2::
    ...
    ggsn::scalebar(data = segs$basin_sf, dist= round((extent/20),digits=0), 
                   ...
                   st.bottom=FALSE, st.size=textsize[4], st.dist=0.03
                   ) +
