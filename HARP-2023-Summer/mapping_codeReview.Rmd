...
# I think we will use either st_combine or st_union and by_feature param = FALSE
regions_geo <- sqldf(
...
regions_grouped <- sqldf( # I don't think this does what I want it to yet
  "SELECT regions_geo.dh_geofield  
   FROM regions_geo
   left outer join 
   GROUP BY VMDWA_Reg2
   ")
