...
## Add: dependence on if variable facil_featr exists yet .. this takes too much time to repeat every run ( use fun exists() )
if (type == "region") {
 ...
 #Get facility coordinates
  for(i in 1:nrow(facil_featr)){ #takes a couple minutes
