...
for (i in 1:length(map_by)) { #execute for each metric in map_by param 
  ...
  metric_unit <- substr(metric, nchar(map_by[i]) - 2, nchar(map_by[i]))  #get metric unit from last 3 characters of metric name
...
## This needs to be modified -- limit BOTH map and table by basin or boundary based on this param -- rename limit
