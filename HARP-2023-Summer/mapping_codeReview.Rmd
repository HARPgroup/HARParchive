...
```{r View Map, echo=FALSE, fig.show='hold', fig.align='center'}
## ^^ doesn't work to get side-by-side maps for the filenames called from a list
#mapfiles <- as.character(mapfilename) #changes from list to character if more than 1, which include_graphics expects
