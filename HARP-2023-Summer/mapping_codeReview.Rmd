...
##Mapping function
  ...
  fn_mapgen(map = "facility", type, map_type, styles[[map_style]], metric_mod, rivseg, bbox, segs, counties, roads, 
...
```{r Rivseg Map Creation, echo=FALSE}
#Adding categories to rivseg df based on the % difference 
rivdiv <- c(50,20,10,0,-10,-20,-50)
...
##Mapping function
  fn_mapgen(map = "riverseg",type, map_type, styles[[map_style]], metric_mod, rivseg, bbox, segs, counties, roads, 
          nhd, maplabs, locality, region, mp_layer, metric_unit)
