...
#determining what metric(s) will be pulled and mapped
  ...
  map_by: ["wsp2020_2040_mgy"] #the metric(s) for mapping, which the bubbles & legend will be scaled to. Ex: runid_11_wd_mgd, fiveyr_avg_mgy
...
rmarkdown::render(paste0(getwd(),"/mapping_codeReview.Rmd"), 
                  ...
                  params = list(
                    ...
                    limit = "basins",
                    table_col = c("runid_11_wd_mgd","runid_13_wd_mgd","wsp2020_2040_mgy"),
                    bbox_type = "auto"))
```
