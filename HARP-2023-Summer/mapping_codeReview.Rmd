...
source(paste0(getwd(), '/', 'fn_mapgen_est.R' )) #load script with mapping function -- does this path work for other analysts?
...
facils$basin <- facils$basin[order(-facils$basin$metric_runid1, -facils$basin$metric_runid2),] # needs to be modified for new metric names
