...
for (i in 1:length(map_by)) { #execute for each metric in map_by param 
  ...
  facils_within$NUM <- seq(1, nrow(facils$within))
...
knitr::include_graphics(c(mapfilename[1],tablefilename)) ## modify to display 2 maps if there are
```
