...
```
  OR
```{r Load Functions from Online, echo=FALSE, eval=FALSE}
...
if (type=="source"){
  ...
  #- - - - add permitted capacity - - - disabled for now , WSP permit capacities almost always @ facility level 
...
```{r Facility-Level Table, warning=FALSE, message=FALSE}
if (type=="facility"){
  if (metric_type=="modeled") {
  table <- data.frame(Number= facils$within$NUM, 
