...
```{r Analysts can: Load Functions from Files, include=FALSE}
## Please leave this chunk during dev for analysts! makes testing & editing functions easier
...
source(github_location,"/HARParchive/HARP-2023-Summer/fn_mapgen_est.R") #load mapping function
source(github_location,"/HARParchive/HARP-2023-Summer/mapstyle_config.R") #load mapping aesthetics
source(github_location,"/HARParchive/HARP-2023-Summer/fn_tablegen.R") #load table function
source(github_location,"/HARParchive/HARP-2023-Summer/fn_labelprep.R") #load labeling function
```
...
```{r (New) Pull Foundational Data, echo=FALSE, eval=FALSE}
...
```{r (Old) Pull Foundational Data, echo=FALSE, include=FALSE}
facils <- list() #create empty list to store dfs
