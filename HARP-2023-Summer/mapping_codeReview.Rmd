...
params:
  ...
  locality: ["Albemarle"]
  region: ["Chowan_1"]    
  type: ["region"] #should be one of: basin, locality, or region ; depending on what map type is desired 
...
```{r Facility Data and Coords for Region maps, warning=FALSE}
...
if (type == "basin") { #'type' variable will either be: basin, locality, or region 
...
if (type == "basin" || type == "locality"){ #facils_within already created for region
...
fn_mapgen(type, style, metric, rivseg, bbox, segs, counties, roads, 
