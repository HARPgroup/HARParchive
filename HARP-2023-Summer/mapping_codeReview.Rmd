...
#determining what metric(s) will be pulled and mapped
  ...
  map_by: ["wd_current_mgy"] #the metric(s) for mapping, which the bubbles & legend will be scaled to. Ex: runid_11_wd_mgd, fiveyr_avg_mgy
...
#asthetic changes  
  ...
  table_col: ["fiveyr_avg_mgy", "wd_current_mgy"] ##specific metrics included in flextable
...
metric_mod <- params$metric_mod #modeled metrics
metric_feat <- params$metric_feat #non-modeled metrics 
