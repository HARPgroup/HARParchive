...
params:
  ...
  metric: ["fiveyr_avg_mgy"] # 5-year avg metric called 'fiveyr_avg_mgy' , which is part of foundational data frame, and not tied to a runid 
  metric_type: ["measured"] #either 'modeled' or 'measured'. Measured metrics not tied to a runid
  map_name: ["NorthernVirginia"]
---
