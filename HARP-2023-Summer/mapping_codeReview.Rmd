...
#New layers for each bin -- might not be necessary
...
fn_mapgen(type, metric, rivseg, bbox, segs, facils, counties, roads, nhd, labelsP, locality, region, mp_layer) #execute mapping function
```
