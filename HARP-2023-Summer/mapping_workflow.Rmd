...
bbox_points <- matrix(nrow = 2, ncol = 2)
bbox_points[,1] = c(ggmap_bbox[1], ggmap_bbox[3])
bbox_points[,2] = c(ggmap_bbox[2], ggmap_bbox[4])
colnames(bbox_points) <- c('long','lat')
