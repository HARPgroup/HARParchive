...
basemap <- ggmap::get_stamenmap(maptype = "terrain", color="color", bbox = ggmap_bbox, zoom = 11)
...
map <- basemap + 
    ...
    # plot labels
    geom_text(data = rseg_labels, aes(X, Y, label = NAME), colour = "#002269", size = 7) +
