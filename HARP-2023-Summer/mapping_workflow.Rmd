...
```{r}
## Joining model data to the foundational dataset
foundatn_join <- sqldf("select * from foundatn left outer join facil_featr on foundatn.Facility_hydroid = facil_featr.featureid 
      UNION 
      select * from facil_featr left outer join foundatn on foundatn.Facility_hydroid = facil_featr.featureid")
