...
tableData <- data.frame(Facility=facil_in_basin$propname, NUM=seq(1, nrow(facil_in_basin))) #need to fix numbers so they coordinate with mapping numbers, right now it just makes a new set 
