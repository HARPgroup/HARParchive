...
# Need to have only 1 row per stream name and 1 geometry representative of that stream (centroid?)
stream.centroid.df <-  data.frame(feature=(1:length(streams_order4$id)),
                                GNIS_NAME=streams_order4$gnis_name,
                                centroid_longitude="",
                                centroid_latitude="",
                                stringsAsFactors=FALSE) 
