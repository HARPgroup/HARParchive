# Inputs (args):
# 1 = path to precip data you want to use
# 2 = path of new csv
...
message("Pull csv from input file path")
...
#What would be the best way to format the output csv?


message(paste0("Write csv in new file path: ",write_path))
write.csv(precip_metric,write_path)
