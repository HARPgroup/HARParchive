...
barplot(nwd_stats$dsum.adj.r.squared ~ nwd_stats$i, main=paste(gage_info$station_nm ), ylim=c(0,1.0))
...
barplot(nldaswk_stats$dsum.adj.r.squared ~ nldaswk_stats$i, main=paste(gage_info$station_nm ), ylim=c(0,1.0))
